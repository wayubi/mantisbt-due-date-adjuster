 ...
 * 
 * This page handles the actual adjustment of the due date
 */

auth_ensure_user_authenticated();
form_security_validate( 'plugin_DueDateAdjuster_adjust' );
...
// Update the bug
$t_bug->due_date = $t_new_due_date;
$t_bug->update( true, true );

// Add history entry
history_log_event_special( $f_bug_id, BUG_DUE_DATE, 
    date( config_get( 'normal_date_format' ), $t_current_due_date ), 
    date( config_get( 'normal_date_format' ), $t_new_due_date ) 
);
...
form_security_purge( 'plugin_DueDateAdjuster_adjust' );
